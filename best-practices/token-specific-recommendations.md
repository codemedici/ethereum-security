...
## [Token integration checklist](https://github.com/crytic/building-secure-contracts/blob/master/development-guidelines/token_integration.md) \(Trail of Bits\)

{% hint style="info" %}
Last updated **18 June 2021**. Check the [Github repo](https://github.com/crytic/building-secure-contracts/blob/master/development-guidelines/token_integration.md) for the most up-to-date version of this particular checklist.
{% endhint %}
...
### Attempted Solutions <a id="attempted-solutions"></a>
...
### The Security Implications <a id="the-security-implications"></a>
